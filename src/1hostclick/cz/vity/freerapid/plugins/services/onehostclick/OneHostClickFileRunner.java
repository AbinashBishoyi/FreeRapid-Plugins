 ...
 * @author birchie
 */
class OneHostClickFileRunner extends AbstractRunner {
    private final static Logger logger = Logger.getLogger(OneHostClickFileRunner.class.getName());
    ...
    public void run() throws Exception {
        ...
        if (makeRedirectedRequest(method)) { //we make the main request
            ...
            while (bReCaptcha) {
                ...
                httpMethod = getMethodBuilder().setActionFromAHrefWhereATagContains(httpFile.getFileName()).toHttpMethod();
