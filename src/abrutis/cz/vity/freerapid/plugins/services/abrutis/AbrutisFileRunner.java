 ...
 * @author birchie
 */
class AbrutisFileRunner extends AbstractRunner {
    private final static Logger logger = Logger.getLogger(AbrutisFileRunner.class.getName());
    ...
    public void run() throws Exception {
        ...
        if (makeRedirectedRequest(method)) { //we make the main request
            ...
            final Matcher match = PlugUtils.matcher("file: \"(.+?)\"", contentAsString);
            if (!match.find())
    ...
    private void checkProblems() throws ErrorDuringDownloadingException {
        ...
        if (contentAsString.contains("<title>Video humour, drole et gratuite</title>")) {
