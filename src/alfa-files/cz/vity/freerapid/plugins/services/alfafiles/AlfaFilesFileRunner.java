...
class AlfaFilesFileRunner extends AbstractRunner {
    ...
    private final static String LANG_REF = "http://alfa-files.com/en";
    ...
    private void checkNameAndSize() throws ErrorDuringDownloadingException {
        try {
            httpFile.setFileName(findNextTextAfter("Download file"));
        } catch (Exception e) {
            throw new PluginImplementationException("File name not found", e);
        }
        try {
            long size = PlugUtils.getFileSizeFromString(findNextTextAfter("Velikost souboru:"));
