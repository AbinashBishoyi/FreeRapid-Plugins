 ...
 * @author birchie
 */
class AnonShareFileRunner extends AbstractRunner {
    private final static Logger logger = Logger.getLogger(AnonShareFileRunner.class.getName());
    ...
    public void runCheck() throws Exception { //this method validates file
        ...
        if (makeRedirectedRequest(getMethod)) {
            ...
            checkProblems();
            throw new ServiceConnectionProblemException("" + getMethod.getStatusLine());
        }
    }

    private void checkNameAndSize(String content) throws ErrorDuringDownloadingException {
        final Matcher match = PlugUtils.matcher("<th class=\"descr\">\\s*?<strong>\\s*?(.+?)\\s*?\\((.+?)\\)<", content);
        if (!match.find())
