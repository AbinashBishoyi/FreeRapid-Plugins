...
public class ImageFunctions {
    ...
    public static ArrayList<Point> getBlock(final BufferedImage image, final int bx, final int by) {
    ...
    public static boolean isWithin(final BufferedImage image, final int x, final int y) {
