...
public class TestApp extends PluginDevApplication {
    ...
    protected void startup() {
        ...
        try {
            ...
            //we set file URL
            httpFile.setNewURL(new URL("http://www.bbc.co.uk/archive/menandmoney/6800.shtml"));
            ...
            final BbcArchiveServiceImpl service = new BbcArchiveServiceImpl(); //instance of service - of our plugin
