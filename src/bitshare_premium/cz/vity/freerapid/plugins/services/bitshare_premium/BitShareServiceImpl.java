...
public class BitShareServiceImpl extends AbstractFileShareService {
    private static final String PLUGIN_CONFIG_FILE = "plugin_BitSharePremium.xml";
    private volatile PremiumAccount config;

    @Override
    public String getName() {
        return "bitshare.com_premium";
    }
    ...
    PremiumAccount showConfigDialog() throws Exception {
        return showAccountDialog(getConfig(), "BitShare", PLUGIN_CONFIG_FILE);
    }

    PremiumAccount getConfig() throws Exception {
        synchronized (BitShareServiceImpl.class) {
            if (config == null) {
