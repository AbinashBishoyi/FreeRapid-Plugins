 ...
 * @author tong2shot
 */
class CelebsXtremeFileRunner extends AbstractRunner {
    private final static Logger logger = Logger.getLogger(CelebsXtremeFileRunner.class.getName());
    ...
    */
    ...
    public void run() throws Exception {
        ...
        Matcher matcher = PlugUtils.matcher("/([^/]+\\.\\w+$)", fileURL);
        if (!matcher.find()) {
