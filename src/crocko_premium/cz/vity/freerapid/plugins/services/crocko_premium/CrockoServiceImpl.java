...
public class CrockoServiceImpl extends AbstractFileShareService {
    private static final String PLUGIN_CONFIG_FILE = "plugin_CrockoPremium.xml";
    private volatile PremiumAccount config;

    @Override
    public String getName() {
        return "crocko.com_premium";
    }
    ...
    PremiumAccount showConfigDialog() throws Exception {
        return showAccountDialog(getConfig(), "Crocko", PLUGIN_CONFIG_FILE);
    }

    PremiumAccount getConfig() throws Exception {
        synchronized (CrockoServiceImpl.class) {
            if (config == null) {
