 ...
 * @author tong2shot
 */
public class DdlStorageServiceImpl extends AbstractFileShareService {
    private static final String PLUGIN_CONFIG_FILE = "plugin_DdlStorage.xml";
    ...
    PremiumAccount getConfig() throws Exception {
        if (config == null) {
            synchronized (DdlStorageServiceImpl.class) {
