 ...
 * @author tong2shot
 */
class FileGazeFileRunner extends AbstractRunner {
    private final static Logger logger = Logger.getLogger(FileGazeFileRunner.class.getName());
    private static final String SERVICE_TITLE = "FileGaze";
    private static final String SERVICE_COOKIE_DOMAIN = ".filegaze.com";
    private static final String SERVICE_LOGIN_REFERER = "http://filegaze.com/login.html";
    private static final String SERVICE_LOGIN_ACTION = "http://filegaze.com/";
    ...
    private boolean login() throws Exception {
        synchronized (FileGazeFileRunner.class) {
            FileGazeServiceImpl service = (FileGazeServiceImpl) getPluginService();
