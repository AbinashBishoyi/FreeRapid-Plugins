 ...
 * @author birchie
 */
class FileShowFileRunner extends XFilePlayerRunner {
    ...
    protected List<FileNameHandler> getFileNameHandlers() {
        ...
        fileNameHandlers.add(new FileNameHandler() {
            ...
            public void checkFileName(HttpFile httpFile, String content) throws ErrorDuringDownloadingException {
                PlugUtils.checkName(httpFile, content, "<title>", " - FileShow.TV");
            }
        });
    ...
    protected List<FileSizeHandler> getFileSizeHandlers() {
        ...
        fileSizeHandlers.add(0, new FileSizeHandler() {
            ...
            public void checkFileSize(HttpFile httpFile, String content) throws ErrorDuringDownloadingException {
                final Matcher match = PlugUtils.matcher(Pattern.quote(httpFile.getFileName()) + " - (\\d.+?)\\s*?</", content);
                if (!match.find())
