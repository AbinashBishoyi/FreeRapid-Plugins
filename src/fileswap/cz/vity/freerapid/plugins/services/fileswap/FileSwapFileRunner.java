 ...
 * @author birchie
 */
class FileSwapFileRunner extends AbstractRunner {
    private final static Logger logger = Logger.getLogger(FileSwapFileRunner.class.getName());
    ...
    private void checkProblems() throws ErrorDuringDownloadingException {
        ...
        if (contentAsString.contains("File Not Found") ||
                contentAsString.contains("The file you requested has not been found")) {
