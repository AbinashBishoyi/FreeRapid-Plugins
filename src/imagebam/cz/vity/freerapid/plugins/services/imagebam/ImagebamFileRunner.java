...
class ImagebamFileRunner extends AbstractRunner {
    ...
    public void run() throws Exception {
        ...
        if (makeRedirectedRequest(method)) { //we make the main request
            ...
            String mLink = PlugUtils.getStringBetween(contentAsString,"<img id=\"the_image\"","alt=\"loading\"");
            mLink = PlugUtils.getStringBetween(mLink,"src=\"","\"");
            logger.info("Link " + mLink);
            
           
            final HttpMethod httpMethod = getMethodBuilder().setReferer(fileURL).setAction(mLink).toHttpMethod();//TODO
