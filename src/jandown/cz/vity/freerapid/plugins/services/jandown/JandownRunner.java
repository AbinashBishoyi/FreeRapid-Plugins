 ...
 * @author Alex
 */
class JandownRunner extends AbstractRunner {
    private final static Logger logger = Logger.getLogger(JandownRunner.class.getName());
    ...
    public void run() throws Exception {
        ...
        if (makeRequest(method)) {
            ...
            client.setReferer("http://www.jandown.com/fetch.php");
            final PostMethod pmethod = getPostMethod("http://www.jandown.com/fetch.php");
