 ...
 * @author birchie
 */
class LumFileFileRunner extends AbstractRunner {
    private final static Logger logger = Logger.getLogger(LumFileFileRunner.class.getName());
    ...
    private void checkNameAndSize(String content) throws ErrorDuringDownloadingException {
        final Matcher filenameMatcher = PlugUtils.matcher("File: <span>(.+)</span>\\[(.+)\\]</h2>", content);
