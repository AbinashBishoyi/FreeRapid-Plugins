...
class MegaShareFileRunner extends AbstractRunner {
    ...
    private void checkNameAndSize(String content) throws ErrorDuringDownloadingException {
        PlugUtils.checkName(httpFile, content, "file:</strong></td>\n<td width=\"79%\">", "</td>");
        PlugUtils.checkFileSize(httpFile, content, "ng:</strong></td>\n<td>", "</td>");
    ...
    public void run() throws Exception {
        ...
        if (makeRedirectedRequest(method)) { //we make the main request
            ...
            final HttpMethod httpMethod = getMethodBuilder().setReferer(fileURL).setBaseURL("http://megashare.vn").setActionFromTextBetween("<a id=\\\"button-large\\\" a href=\\\"", "\\\">").toHttpMethod();
