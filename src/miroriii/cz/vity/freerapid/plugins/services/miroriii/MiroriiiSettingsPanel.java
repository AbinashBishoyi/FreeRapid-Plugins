 ...
 * @author ntoskrnl
 */
public class MiroriiiSettingsPanel extends JPanel {
    ...
    private final JCheckBox AddLink = new JCheckBox("Add new link");

    public MiroriiiSettingsPanel(MiroriiiServiceImpl service) throws Exception {
        super();
    ...
    private void initPanel() {
        ...
        AddLink.setSelected(config.getAddLink());
        ...
        AddLink.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                config.setAddLink(AddLink.isSelected());
            }
        });
        ...
        layout.setHorizontalGroup(
                layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup()
                                ...
                                .addComponent(AddLink, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addContainerGap()
        );
        ...
        layout.setVerticalGroup(
                layout.createSequentialGroup()
                        ...
                        .addComponent(AddLink, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)
                        .addContainerGap()
        );
    }
