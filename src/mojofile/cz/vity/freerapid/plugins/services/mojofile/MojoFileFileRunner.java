 ...
 * @author birchie
 */
class MojoFileFileRunner extends AbstractRunner {
    private final static Logger logger = Logger.getLogger(MojoFileFileRunner.class.getName());

    @Override
    public void runCheck() throws Exception { //this method validates file
        super.runCheck();
        addCookie(new Cookie(".mojofile.com", "lang", "english", "/", 86400, false));
    ...
    private void checkNameAndSize(String content) throws ErrorDuringDownloadingException {
        ...
        final Matcher filenameMatcher = PlugUtils.matcher("\\((.*\\s*[KMG]?B)\\)", content);
    ...
    public void run() throws Exception {
        ...
        if (makeRedirectedRequest(method)) { //we make the main request
            ...
            while (bReCaptcha) {
                ...
                Integer iWait = PlugUtils.getNumberBetween(PlugUtils.getStringBetween(contentAsString, "wait for", "seconds"), "\">", "</span>");
