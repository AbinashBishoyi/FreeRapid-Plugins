 ...
 * @author JPEXS
 */
class MultiShareFileRunner extends AbstractRunner {
    private final static Logger logger = Logger.getLogger(MultiShareFileRunner.class.getName());
    ...
    public void run() throws Exception {
        ...
        if (makeRedirectedRequest(method)) { //we make the main request
            ...
            final HttpMethod httpMethod = getMethodBuilder().setReferer(fileURL).setActionFromAHrefWhereATagContains("Stahuj zdarma").setBaseURL(SERVER_URL).toHttpMethod();
