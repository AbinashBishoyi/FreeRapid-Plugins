 ...
 * @author tong2shot
 */
public class NbcHdsDownloader extends HdsDownloader {
    private final int configBitrate;

    public NbcHdsDownloader(HttpDownloadClient client, HttpFile httpFile, HttpFileDownloadTask downloadTask, int configBitrate) {
