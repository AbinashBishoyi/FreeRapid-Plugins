 ...
 * @author birchie
 */
class PigSonicFileRunner extends AbstractRunner {
    private final static Logger logger = Logger.getLogger(PigSonicFileRunner.class.getName());
    ...
    private void checkNameAndSize(String content) throws ErrorDuringDownloadingException {
        PlugUtils.checkName(httpFile, content, "<h2>Download File ", " <");
        PlugUtils.checkFileSize(httpFile, content, "id=\"span1\">(", ")<");
    ...
    private void checkProblems() throws ErrorDuringDownloadingException {
        ...
        if (contentAsString.contains("<b>NOT BE FOUND")) {
        ...
        if (contentAsString.contains("You can download files up to")) {
            throw new NotRecoverableDownloadException(PlugUtils.getStringBetween(contentAsString, "<div class=\"err\">", "<br>"));
        }
        ...
        if (contentAsString.contains("file is available to premium users only")
                || contentAsString.contains("this file requires premium to download")) {
