...
public class TestApp extends PluginDevApplication {
    ...
    protected void startup() {
        ...
        try {
            //we set file URL
            httpFile.setNewURL(new URL("http://yyning.qjwm.com/down_1277547.html"));
...
//            connectionSettings.setProxy("61.50.138.124", 3128); //eg we can use local proxy to sniff HTTP communication
            ...
            final QjwmServiceImpl service = new QjwmServiceImpl(); //instance of service - of our plugin
