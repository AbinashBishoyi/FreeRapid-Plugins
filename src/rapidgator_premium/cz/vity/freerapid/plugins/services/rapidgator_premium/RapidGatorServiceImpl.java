...
public class RapidGatorServiceImpl extends AbstractFileShareService {
    private static final String PLUGIN_CONFIG_FILE = "plugin_RapidGatorPremium.xml";
    private volatile PremiumAccount config;

    @Override
    public String getName() {
        return "rapidgator.net_premium";
    }
    ...
    PremiumAccount showConfigDialog() throws Exception {
        return showAccountDialog(getConfig(), "RapidGator", PLUGIN_CONFIG_FILE);
    }

    PremiumAccount getConfig() throws Exception {
        synchronized (RapidGatorServiceImpl.class) {
            if (config == null) {
