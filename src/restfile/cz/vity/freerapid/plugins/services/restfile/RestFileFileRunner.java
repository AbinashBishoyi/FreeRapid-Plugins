 ...
 * @author tong2shot
 */
class RestFileFileRunner extends AbstractRunner {
    private final static Logger logger = Logger.getLogger(RestFileFileRunner.class.getName());
    private final static String SERVICE_TITLE = "RestFile";
    private final static String SERVICE_COOKIE_DOMAIN = ".restfile.com";
    private final static String SERVICE_LOGIN_REFERER = "http://www.restfile.com/login.html";
    private final static String SERVICE_LOGIN_ACTION = "http://www.restfile.com";
    ...
    private boolean login() throws Exception {
        synchronized (RestFileFileRunner.class) {
            RestFileServiceImpl service = (RestFileServiceImpl) getPluginService();
    ...
    private void checkFileProblems() throws ErrorDuringDownloadingException {
        ...
        if (contentAsString.contains("server is in maintenance mode")) {
            throw new YouHaveToWaitException("This server is in maintenance mode", 30 * 60);
        }
    }
