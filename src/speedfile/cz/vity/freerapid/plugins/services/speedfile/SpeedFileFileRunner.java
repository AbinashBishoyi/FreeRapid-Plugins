...
class SpeedFileFileRunner extends AbstractRunner {
    ...
    private void checkNameAndSize(String content) throws ErrorDuringDownloadingException {
        ...
        PlugUtils.checkFileSize(httpFile, content, "<big>", "|");
    ...
    public void run() throws Exception {
        ...
        if (makeRedirectedRequest(method)) { //we make the main request
            ...
            final HttpMethod httpMethod = getMethodBuilder().setBaseURL(fileURL).setReferer(fileURL).setActionFromAHrefWhereATagContains("<span>").toHttpMethod();
            logger.info(httpMethod.getURI().toString());
            makeRequest(httpMethod);
            downloadTask.sleep(11);
