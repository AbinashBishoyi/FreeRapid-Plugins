package cz.vity.freerapid.plugins.services.subscene;
 ...
 * @author birchie
 */
class SubSceneFileRunner extends AbstractRunner {
    private final static Logger logger = Logger.getLogger(SubSceneFileRunner.class.getName());
    ...
    private void checkProblems() throws ErrorDuringDownloadingException {
        ...
        if (contentAsString.contains("Page Not Found")
                || contentAsString.contains("Could not find the page you requested")) {
