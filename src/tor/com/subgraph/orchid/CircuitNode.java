...
/**
 * Represents the state of a single onion router hop in a connected or connecting {@link com.subgraph.orchid.Circuit}
 */
public interface CircuitNode {
    /**
     * Return the {@link com.subgraph.orchid.Router} associated with this node.
     *
     * @return The {@link com.subgraph.orchid.Router} for this hop of the circuit chain.
     */
    Router getRouter();
     ...
     *
     * @param cell The {@link com.subgraph.orchid.RelayCell} to add to the digest.
     */
    ...
    /**
     * Encrypt a {@link com.subgraph.orchid.RelayCell} for this node with the current
     * 'forward' cipher state.
     *
     * @param cell The {@link com.subgraph.orchid.RelayCell} to encrypt.
     */
    void encryptForwardCell(RelayCell cell);

    /**
     * Return the {@link com.subgraph.orchid.CircuitNode} which immediately preceeds this
     * one in the circuit node chain or <code>null</code> if this is
     * the first hop.
     *
     * @return The previous {@link com.subgraph.orchid.CircuitNode} in the chain or <code>
