...
public interface Connection {
    /**
     * Return the {@link com.subgraph.orchid.Router} associated with this connection.
     *
    ...
    /**
     * Send a protocol {@link com.subgraph.orchid.Cell} on this connection.
     *
     * @param cell The {@link com.subgraph.orchid.Cell} to transfer.
    ...
    /**
     * Remove a Circuit which has been bound to this Connection by a previous call to {@link #bindCircuit(com.subgraph.orchid.Circuit) bindCircuit}.
     ...
     * Once bound, any incoming relay cells will be delivered to the Circuit with {@link com.subgraph.orchid.Circuit#deliverRelayCell(com.subgraph.orchid.Cell)}
     * and other cells will be delivered with {@link com.subgraph.orchid.Circuit#deliverControlCell(com.subgraph.orchid.Cell)}.
     *
