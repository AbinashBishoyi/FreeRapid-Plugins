 ...
 * {@link #isValidPublicValue(java.math.BigInteger)} should be called to verify that the peer has sent a safe
 * and legal public value.  If {@link #isValidPublicValue(java.math.BigInteger)} returns true, the peer public
 * value is valid and {@link #getSharedSecret(java.math.BigInteger)} can be called to complete the key agreement
