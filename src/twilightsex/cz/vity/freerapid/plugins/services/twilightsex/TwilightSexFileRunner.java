 ...
 * @author birchie
 */
class TwilightSexFileRunner extends AbstractRunner {
    private final static Logger logger = Logger.getLogger(TwilightSexFileRunner.class.getName());
    ...
    public void run() throws Exception {
        ...
        if (makeRedirectedRequest(method)) { //we make the main request
            ...
            final HttpMethod httpMethod = getMethodBuilder()
                    .setAction(PlugUtils.getStringBetween(contentAsString, "<a href=\"", "\">Download Movie"))
                    .setReferer(fileURL)
                    .toPostMethod();
    ...
    private void checkProblems() throws ErrorDuringDownloadingException {
        ...
        if (contentAsString.contains("The file you have requested was not found on this server") ||
                contentAsString.contains("This page was not found")) {
