...
public class FingerprintProperties {
    ...
    private int sampleSizePerFrame = 128;    // number of audio samples in a frame, it is suggested to be the FFT Size
    ...
    private int upperBoundedFrequency = 2500;    // low pass
    private int lowerBoundedFrequency = 400;    // high pass
    private int fps = 124;    // in order to have 5fps with 2048 sampleSizePerFrame, wave's sample rate need to be 10240 (sampleSizePerFrame*fps)
