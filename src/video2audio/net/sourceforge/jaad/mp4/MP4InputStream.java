...
public class MP4InputStream {
     ...
     * @throws java.io.IOException If the end of the stream is detected or any I/O error occurs.
     */
     ...
     * @throws java.io.IOException If the end of the stream is detected, the input
     ...
     * @throws java.io.IOException if an I/O error occurs (only when using a RandomAccessFile)
     */
     ...
     *            stream
     * @throws java.io.IOException if an InputStream is used, pos is less than 0 or an
     *                             I/O error occurs
     */
