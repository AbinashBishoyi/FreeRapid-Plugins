...
public class TrackExtendsBox extends FullBox {
     ...
     * @see net.sourceforge.jaad.mp4.boxes.impl.SampleDependencyTypeBox#getSampleDependsOn()
     */
     ...
     * @see net.sourceforge.jaad.mp4.boxes.impl.SampleDependencyTypeBox#getSampleIsDependedOn()
     */
     ...
     * @see net.sourceforge.jaad.mp4.boxes.impl.SampleDependencyTypeBox#getSampleHasRedundancy()
     */
     ...
     * @see net.sourceforge.jaad.mp4.boxes.impl.PaddingBitBox#getPad1()
     */
