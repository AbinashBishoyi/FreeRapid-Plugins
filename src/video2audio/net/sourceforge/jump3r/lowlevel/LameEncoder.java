package net.sourceforge.jump3r.lowlevel;

import net.sourceforge.jump3r.mp3.*;
import net.sourceforge.jump3r.mpg.Common;
import net.sourceforge.jump3r.mpg.Interface;
import net.sourceforge.jump3r.mpg.MPGLib;
...
public class LameEncoder {
    ...
    public static final Encoding MPEG1L3 = new Encoding(
            "MPEG1L3");
    // Lame converts automagically to MPEG2 or MPEG2.5, if necessary.
    public static final Encoding MPEG2L3 = new Encoding(
            "MPEG2L3");
    public static final Encoding MPEG2DOT5L3 = new Encoding(
            "MPEG2DOT5L3");
...
//					System.out.println(Arrays.toString(sample));
    ...
    public Encoding getEffectiveEncoding() {
