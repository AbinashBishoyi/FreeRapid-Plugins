...
package net.sourceforge.jump3r.mpg;

import net.sourceforge.jump3r.mp3.VBRTag;
import net.sourceforge.jump3r.mp3.VBRTagData;
import net.sourceforge.jump3r.mpg.Decode.Factory;
import net.sourceforge.jump3r.mpg.MPGLib.ProcessedBytes;
import net.sourceforge.jump3r.mpg.MPGLib.buf;
import net.sourceforge.jump3r.mpg.MPGLib.mpstr_tag;
...
//	#endif
    ...
    <T> int
    decodeMP3(mpstr_tag mp, byte[] in, int bufferPos, int isize, T[] out, int osize, ProcessedBytes done, Factory<T> tFactory) {
        if (osize < 2304) {
    ...
    <T> int
    decodeMP3_unclipped(mpstr_tag mp, byte[] in, int bufferPos, int isize, T[] out, int osize, ProcessedBytes done, Factory<T> tFactory) {
