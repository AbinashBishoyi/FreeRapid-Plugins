...
public class WebShareServiceImpl extends AbstractFileShareService {
    private static final String PLUGIN_CONFIG_FILE = "plugin_WebSharePremium.xml";
    ...
    PremiumAccount showConfigDialog() throws Exception {
        return showAccountDialog(getConfig(), "WebShare.cz", PLUGIN_CONFIG_FILE);
    }

    PremiumAccount getConfig() throws Exception {
        synchronized (WebShareServiceImpl.class) {
            if (config == null) {
