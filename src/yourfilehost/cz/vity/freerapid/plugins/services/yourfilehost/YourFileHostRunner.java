...
class YourFileHostRunner extends AbstractRunner {
    ...
    public void run() throws Exception {
        ...
        if (makeRedirectedRequest(getMethod)) {
            ...
            } else if (contentAsString.contains("www.yourfilehost.com/postroll-live.php")) {
                //http://www.yourfilehost.com/postroll-live.php?vidlink=http://68.64.152.152/dl/d74e029c7646feb969b4af502d362cfb/1229854808/video/08511218_siemens.wmv&rand=1229854808">

                //String vidEmbed = PlugUtils.getParameter("URL", contentAsString);
                Matcher vidURL = PlugUtils.matcher("vidlink=([^\"]+)&rand", contentAsString);
                if (vidURL.find()) {
            ...
            } else throw new InvalidURLOrServiceProblemException("Can't find download page 7");
        } else throw new InvalidURLOrServiceProblemException("Can't load download link 8");
    }
