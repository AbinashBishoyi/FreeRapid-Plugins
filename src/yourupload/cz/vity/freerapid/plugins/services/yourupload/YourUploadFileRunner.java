 ...
 * @author birchie
 */
class YourUploadFileRunner extends AbstractRunner {
    private final static Logger logger = Logger.getLogger(YourUploadFileRunner.class.getName());
    ...
    private void checkNameAndSize(String content) throws ErrorDuringDownloadingException {
        ...
        final Matcher match = PlugUtils.matcher("Size</b>\\s+?</td>\\s+?<td>(.+?)<", content);
        if (!match.find())
